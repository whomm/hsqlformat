...
// select a,b,c ...
selectClause
@init { gParent.pushMsg(retval.start,"select clause", state); }
...
selectList
@init { gParent.pushMsg(retval.start,"select list", state); }
@after { gParent.popMsg(state); }
    :
...
selectTrfmClause
@init { gParent.pushMsg(retval.start,"transform clause", state); }
@after { gParent.popMsg(state); }
    :
...
selectItem
@init { gParent.pushMsg(retval.start,"selection target", state); }
@after { gParent.popMsg(state); }
    :
...
selectExpression
@init { gParent.pushMsg(retval.start,"select expression", state); }
@after { gParent.popMsg(state); }
    :
...
@init { gParent.pushMsg(retval.start,"select expression list", state); }
@after { gParent.popMsg(state); }
    :
...
window_clause
@init { gParent.pushMsg(retval.start,"window_clause", state); }
@after { gParent.popMsg(state); }
:
...
window_defn
@init { gParent.pushMsg(retval.start,"window_defn", state); }
@after { gParent.popMsg(state); }
:
...
@init { gParent.pushMsg(retval.start,"window_specification", state); }
@after { gParent.popMsg(state); }
:
...
window_range_expression
@init { gParent.pushMsg(retval.start,"window_range_expression", state); }
@after { gParent.popMsg(state); }
:
...
window_value_expression
@init { gParent.pushMsg(retval.start,"window_value_expression", state); }
@after { gParent.popMsg(state); }
:
...
@init { gParent.pushMsg(retval.start,"windowframestartboundary", state); }
@after { gParent.popMsg(state); }
:
...
@init { gParent.pushMsg(retval.start,"windowframeboundary", state); }
@after { gParent.popMsg(state); }
:
